...
class Anonymous extends CI_Controller
{
    ...
    public function initPost()
    {
        ...
        if ($pwd == null || password_verify($pwd, password_hash("admin", PASSWORD_DEFAULT))) {
            ...
            $this->profesional_model->crearProfesional('Antonio', 'Garcia', "Marquez","33344455Y","1234","Plaza castilla-leon, 7, 1-B", "Conde de Casal", "Madrid", 576483934, "takecaretfg@gmail.com","Hombre" , $this->pais_model->getPaisById(5), "4/9/1994", $this->especialidad_model->getEspecialidadById(1),"Autonomo/a","Tarde", "17:00-21:00",40,"jpg");
            $this->profesional_model->crearProfesional('Leire', 'Rivera', "Del Rio","76544455Y","1234","Calle robledal 8", "Coslada", "Madrid", 495394831, "emailLeire@gmail.com","Mujer", $this->pais_model->getPaisById(6), "4/9/1994", $this->especialidad_model->getEspecialidadById(1),"Clinica Las lagunas","Mañana y Tarde","09:00-18:00",35, "jpg");
            $this->profesional_model->crearProfesional('Daniel', 'Martinez', "Cabrales","93567455Y","1232","Calle Capitan America, 32", "Torrejon de Ardoz", "Madrid", 485337564, "emailDaniel@gmail.com","Hombre" , $this->pais_model->getPaisById(4),"4/9/1994", $this->especialidad_model->getEspecialidadById(2),"Autonomo/a","Tarde","15:00-21:30",40,"jpg");
            $this->profesional_model->crearProfesional('Alberto', 'Pascual', "Jimenez", "34256542V","1233", "Calle de Segovia, 21", "Madrid", "Madrid", 663283456, "emailAlberto@gmail.com", "Hombre", $this->pais_model->getPaisById(8), "29/3/1998", $this->especialidad_model->getEspecialidadById(3),"Garrigues médicos","Mañana","08:00-14:00",32, "jpg");
            ...
            $this->profesional_model->crearProfesional('Antonio', 'Paterna', "Benito", "67859035A", "Password2", "Calle Izelaieta, 34", "Bilbao", "Vizcaya", 636782345, "emailAntonioP@gmail.com", "Hombre", $this->pais_model->getPaisById(8), "16/9/1992", $this->especialidad_model->getEspecialidadById(5),"Dermatólogos Paterna","Tarde","16:00-20:00",25, "jpg");
            $this->profesional_model->crearProfesional('Alejandro', 'Pérez', "Yunqueras", "75486359G", "Password3", "Calle de pez, 1", "Madrid", "Madrid", 943586124, "emailAlejandro@gmail.com", "Hombre", $this->pais_model->getPaisById(8), "10/1/1975", $this->especialidad_model->getEspecialidadById(6),"Parlem Junts","Tarde","16:00-23:00",70,"jpg");
            $this->profesional_model->crearProfesional('Laura', 'Baltar', "Fernandez", "31486396H", "Password4", "Calle de Piñor, 38", "Cangas", "Pontevedra", 636487569, "emailLaura@gmail.com", "Mujer", $this->pais_model->getPaisById(8), "2/7/1989", $this->especialidad_model->getEspecialidadById(7),"Autonomo/a","Mañana","06:00-11:00",40, "jpg");
            $this->profesional_model->crearProfesional('José Antonio', 'González', "Mestalla", "06463745M", "Password5", "Calle Pintor Rosales, 34", "Madrid", "Madrid", 843657414, "emailJose@gmail.com", "Hombre", $this->pais_model->getPaisById(8), "24/12/1990", $this->especialidad_model->getEspecialidadById(8),"Autonomo/a","Mañana y Tarde","08:00-17:00",43, null);
            $this->profesional_model->crearProfesional('Jorge', 'Mayo', "Bencomo", "68842379J", "Password6", "Rua Augusta, 25", "Rivas","Madrid", 943854721, "emailJorge@gmail.com", "Hombre", $this->pais_model->getPaisById(22), "30/5/1982", $this->especialidad_model->getEspecialidadById(9),"Asisu","Mañana","07:00-11:00",30, null);
            $this->profesional_model->crearProfesional('Iván', 'Da Conçeicao', "Martín", "53781965P", "Password7", "Calle de caballero de Gracia, 30", "Madrid", "Madrid", 643172098, "emailIvan@gmail.com", "Hombre", $this->pais_model->getPaisById(8), "20/2/1985", $this->especialidad_model->getEspecialidadById(11),"Autonomo/a","Mañana","06:00-10:00",50, null);
        ...
        try {
            ...
            try {
                if ($tipoUsuario == 1) {
                    ...
                    $id = $this->profesional_model->crearProfesional($nombre, $primerNombre, $segundoNombre ,$dni,$password, $direccion, $ciudad, $provincia, $telefono, $email, $genero, $this->pais_model->getPaisById($pais),$fechaNacimiento, $this->especialidad_model->getEspecialidadById($especilidad),$clinica,$turno,$franja,$tarifa, $extFoto);
