...
class Anonymous extends CI_Controller
{
    ...
    public function initPost()
    {
        ...
        if ($pwd == null || password_verify($pwd, password_hash("admin", PASSWORD_DEFAULT))) {
            ...
            $this->persona_model->crearPersona('Noel','Rodríguez',"Taboada","06597331Q","Passwordnoel1","Avenida Somorrostro 185 1C", "Madrid", "madrid", 636089657, "noel@gmail.com", "Hombre", "0+", $this->pais_model->getPaisById(8), "10-3-1998", null);
            $this->persona_model->crearPersona('Laura','González',"Aragón","75349538J","Lauragonzalez1","Calle Hellín 33 5C", "Madrid", "madrid", 649722097, "laura.gon.ara3@gmail.com", "Mujer", "0-", $this->pais_model->getPaisById(8), "22-5-1995", null);
            $this->persona_model->crearPersona('Victor','Rivera',"Mansilla","62273879B","Passwordvictor1","Calle Mikel Zarate 14 2C", "Mallabia", "vizcaya", 943786534, "victor@gmail.com", "Hombre", "A+", $this->pais_model->getPaisById(8), "24-12-1993", null);
