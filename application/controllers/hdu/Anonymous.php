    ...
    public function enviarMailRecuPass()
    {
        ...
        if ($this->persona_model->existEmail($email)) { // si ese mail existe en la base de datos
            ...
            <p style="text-align: center;
             ...
             padding: 10px;
             vertical-align: middle;">Para hacer reset por favor haz clic en el siguiente enlace <a href='" . base_url() . "hdu/anonymous/resetPass/" . $verification_key . "/" . $email . "'>Cambiar contraseña</a></p>
                        <p style="text-align: center;
             color: #9A0606;
             font-size: x-large;
             font-variant: small-caps;
             padding: 10px;
             vertical-align: middle;">Gracias!!!</p>
HTML;
