		...
		<div class="col-md-12 mx-auto">
			<div class="container bg-white">
				<div class="col-md-12 mx-auto">
					<br>
					<h3>
						<b class="textoexp2">¿Quiénes somos?</b>
					</h3>
					<br>

					<p class="textoexp2">Take Care nace en el año 2020 como proyecto de fin de
					...
					<p class="textoexp2">Han sido muchas herramientas y tecnologías utilizadas
						para el desarrollo y la finalización del sitio web. Estas,
						se han utilizado en base a los requerimientos del mismo, y las
						...
						trayectoria profesional y futuras colaboraciones entre todas las
						personas que nos han acompañado durante todo este tiempo.</p>

					<p class="textoexp2">Muchas gracias de parte del equipo de Take Care.</p>
